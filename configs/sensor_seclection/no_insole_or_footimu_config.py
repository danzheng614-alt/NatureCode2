...
model_path = os.path.join("models", "trained_tcn_no_insole_or_footimu.tar")

# 获取当前配置文件（all_sensors_no_insole_config.py）的绝对路径
current_file_path = os.path.abspath(__file__)
# 向上跳转 3 级目录，回到项目根目录（capsule-5421243-code/）
project_root = os.path.dirname(os.path.dirname(os.path.dirname(current_file_path)))
# 拼接数据目录的绝对路径
data_dir = os.path.join(project_root, "data", "Phase1And2_Complete", "Complete")
...
input_names = ["shank_imu_*_gyro_x", "shank_imu_*_gyro_y", "shank_imu_*_gyro_z", 
